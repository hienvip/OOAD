...
<?php
	...
	if (isset($_SESSION['account'])) {
		//header("location: http://localhost/ooad/$backLink");
	}
?>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="http://localhost/ooad/controller/ProductsController.php">Books</a></li>
								</ul>
							</div>
							</nav>
			</div>
	...
	<div class="login">
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form action="http://localhost/ooad/controller/LoginController.php" method="POST">
